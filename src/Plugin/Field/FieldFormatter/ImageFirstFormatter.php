...
namespace Drupal\image_first_formatter\Plugin\Field\FieldFormatter;
 ...
 * @FieldFormatter(
 *   id = "image_first",
 *   label = @Translation("Image First"),
 *   field_types = {
 *     "image"
 *   }
 * )
 */
class ImageFirstFormatter extends ImageFormatterBase implements ContainerFactoryPluginInterface {
